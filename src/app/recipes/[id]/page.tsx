    ...
    <PageShell title={recipe.name}>
      ...
      <Card>
        ...
        <div className="grid gap-2 md:grid-cols-3">
          ...
          <Button onClick={async () => { await plannerRepo.save({ weekStart: startOfWeekIso(), dayIndex: Number(day), slot, recipeId: recipe.id }); await planner.reload(); toast.success("Added to planner"); }}>Add</Button>
        </div>
      </Card>
